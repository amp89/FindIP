...
public class IpNavigationController {
	...
	private ModelAndView updateAcccountPage(HttpSession session){
		return getUserAndAccessTokenMV((CurrentUser)session.getAttribute("currentUserLogin"),"changeData");
	}
