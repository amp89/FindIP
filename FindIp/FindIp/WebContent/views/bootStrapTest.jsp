...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">FindIP</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a class="active" href="index.do">Home<span class="sr-only">(current)</span></a></li>
    ...
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="bootstrapfiles/assets/js/assets/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
