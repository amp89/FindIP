 ...
 * Generated at: 2016-07-28 08:59:31 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t$(\"title\").text(\"IpFind | My Stuff\");\n");
      out.write("\t});\n");
      out.write("\t</script>\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /views/dashboard.jsp(10,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t<div id=\"pageTitle\" class=\"text-center\">Dashboard</div>\n");
        out.write("\t\n");
        out.write("\t<div class=\"col-xs-12 text-center\">\n");
        out.write("\t\t<a href=\"updateAccount.do\">Change Your Email or Password</a>\n");
        out.write("\t</div>\n");
        out.write("\n");
        out.write("\t\n");
        out.write("\t\n");
        out.write("\t<div ng-app=\"userDataApp\" ng-controller=\"userController\">\n");
        out.write("\t\t<h2>Your Saves:</h2>\n");
        out.write("\t\t\t<div class=\"col-xs-12 col-md-6 save-result\" ng-repeat=\"s in userData.saves\">\n");
        out.write("\t\t\t\t<ul>\n");
        out.write("\t\t\t\t\t<li>Address range: {{s.address.startIp}} to {{s.address.endIp}}</li>\n");
        out.write("\t\t\t\t\t<li>Location: {{s.address.city}}, {{s.address.region}}, {{s.address.countryName}} </li>\n");
        out.write("\t\t\t\t\t<li>Lat: {{s.address.latitude}} Lon: {{s.address.longitude}}</li>\n");
        out.write("\t\t\t\t\t<li ng-show=\"s.publicComment || s.privateComment\">Comments:\n");
        out.write("\t\t\t\t\t\t<ul ng-show=\"s.publicComment\">Public:\n");
        out.write("\t\t\t\t\t\t\t<li ng-show=\"s.publicComment\">{{s.publicComment}}</li>\n");
        out.write("\t\t\t\t\t\t</ul>\n");
        out.write("\t\t\t\t\t\t<ul ng-show=\"s.privateComment\">Public:\n");
        out.write("\t\t\t\t\t\t\t<li ng-show=\"s.privateComment\">{{s.privateComment}}</li>\n");
        out.write("\t\t\t\t\t\t</ul>\n");
        out.write("\t\t\t\t\t</li>\n");
        out.write("\t\t\t\t</ul>\n");
        out.write("\t\t\t\t\t<button class=\"fill_div\" ng-click=\"deleteSave(s.id)\">DELETE</button>\n");
        out.write("\t\t\t</div>\n");
        out.write("\t\t\n");
        out.write("\t\n");
        out.write("\t\n");
