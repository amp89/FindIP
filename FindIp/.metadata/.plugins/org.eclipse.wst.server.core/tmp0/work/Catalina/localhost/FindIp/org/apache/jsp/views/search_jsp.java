 ...
 * Generated at: 2016-07-20 21:03:34 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<h3>IP: {{ipResponseData.startIp}} to {{ipResponseData.endIp}}</h2>\n");
      out.write("\t\t<h2>Location:</h2>\n");
      out.write("\t\t<h3>{{ipResponseData.region}}, {{ipResponseData.city}}, {{ipResponseData.countryName}}</h3>\n");
      out.write("\t\t<h3>Lat: {{ipResponseData.latitude}} to {{ipResponseData.longitude}}</h3>\n");
      out.write("\t\t\t<form name=\"ipSaveForm\" ng-submit=\"saveIp()\">\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\tPublic Comments (Optional):<br>\n");
      out.write("\t\t\t\t<textarea rows=\"5\" cols=\"50\" ng-maxlength=\"10000\" name=\"publicComments\" ng-model=\"ipSaveData.publicComment\"></textarea>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tPrivate Comments (Optional):<br>\n");
      out.write("\t\t\t\t<textarea rows=\"5\" cols=\"50\" ng-maxlength=\"10000\"  name=\"privateComments\" ng-model=\"ipSaveData.privateComment\"></textarea>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t<button type=\"submit\" ng-disabled=\"ipSaveForm.$invalid\">Save!</button>\n");
      out.write("\t\t\t\t<span ng-show=\"ipSaveForm.$invalid\">Please keep comments under 10000 characters.</span>\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t\n");
      out.write("\t\t<div>\n");
      out.write("\t</div>\n");
      ...
      out.write(";\n");
      out.write("\t\t\tipSaveData.ipId = ipResponseData.id;\n");
      out.write("\t\t\tipSaveData.acccessToken = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${accessToken}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(";\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t$http({\n");
